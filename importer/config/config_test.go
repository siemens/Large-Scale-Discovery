...
func TestGetConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{"empty-importerConfig", ImporterConfig{}},
		{"default-importerConfig", defaultImporterConfigFactory()}, // Default conf will be loaded after first unittest
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
		...
		conf := defaultImporterConfigFactory()
		Set(&conf)
	}
}
...
func TestLoad(t *testing.T) {
	...
	tests := []struct {
		...
		path     string
		wantErr  bool
		wantConf ImporterConfig
	}{
		{"", testFile, false, defaultImporterConfigFactory()},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestSet(t *testing.T) {
	...
	tests := []struct {
		...
		{"sample", defaultImporterConfigFactory(), defaultImporterConfigFactory()},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			Set(&tt.conf)
...
func TestSave(t *testing.T) {
	...
	tests := []struct {
		...
		{"first-save", args{defaultImporterConfigFactory(), testFile}, false},
		{"second-save", args{defaultImporterConfigFactory(), testFile}, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
