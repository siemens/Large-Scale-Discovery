...
func TestGetConfig(t *testing.T) {
	...
	// Set the initial global importer config, in case all test cases get executed at once it will be already set.
	Set(&ImporterConfig{})
	...
	tests := []struct {
		...
		{
			name: "empty-importerConfig",
			want: ImporterConfig{},
		},
		{
			name: "default-importerConfig", // Default conf will be loaded after first unittest.
			want: defaultImporterConfigFactory(),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestLoad(t *testing.T) {
	...
	wantConf := defaultImporterConfigFactory()
...
func TestSave(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "first-save",
			args:    args{conf: defaultImporterConfigFactory(), path: testFile},
			wantErr: false,
		},
		{
			name:    "second-save",
