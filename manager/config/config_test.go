...
func TestGetConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{"empty-managerConfig", ManagerConfig{}},
		{"default-managerConfig", defaultManagerConfigFactory()}, // Default conf will be loaded after first unittest
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestLoad(t *testing.T) {
	...
	tests := []struct {
		...
		{"", testFile, false, defaultManagerConfigFactory()},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestSet(t *testing.T) {
	...
	tests := []struct {
		...
		{"sample", defaultManagerConfigFactory(), defaultManagerConfigFactory()},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			Set(&tt.conf)
...
func TestSave(t *testing.T) {
	...
	tests := []struct {
		...
		{"first-save", args{defaultManagerConfigFactory(), testFile}, false},
		{"second-save", args{defaultManagerConfigFactory(), testFile}, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
